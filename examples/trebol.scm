...
(let* ((cyl1 (cylinder '(0 0 0) '(1 0 0) 5))
       ...
       (pl1 (halfspace '(0 0 0) '(-1 0 0)))
       (pl2 (halfspace '(0 0 0) '(0 -1 0)))
       (pl3 (halfspace '(0 0 0) '(0 0 -1)))
       (blend (elliptic-blend (list (intersection cyl1 pl1)
                                    (intersection cyl2 pl2)
                                    (intersection cyl3 pl3))
                              '(1 1 1) 3))
       (pl1 (halfspace '(10 0 0) '(1 0 0)))
       (pl2 (halfspace '(0 10 0) '(0 1 0)))
       (pl3 (halfspace '(0 0 10) '(0 0 1)))
       (sp (sphere '(0 0 0) 5))
       (sp1 (sphere '(10 0 0) 5))
       (sp2 (sphere '(0 10 0) 5))
       (sp3 (sphere '(0 0 10) 5))
